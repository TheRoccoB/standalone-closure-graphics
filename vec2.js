// Derived from:
// http://closure-library.googlecode.com/svn/docs/class_goog_graphics_Vec2.html
// By: Rocco Balsamo
 ...
 *   goog.base(this, a, b);
 * }
 * _inherits(ChildClass, ParentClass);
 *
...
/**
 * Normalizes the current vector to have a magnitude of 1.
 * if magnitude is 0, it doesn't modify the current vector.
 * @return {!Vec2} The normalized vector.
 */
Vec2.prototype.safeNormalize = function() {
...
/**
 * Adds another vector to this vector in-place. Uses Vec2.sum(a, b) to
 * return a new vector.
 ...
 * Vec2.difference(a, b) to return a new vector.
 ...
 */
Vec2.distance = Coordinate.distance;
 ...
 */
Vec2.squaredDistance = Coordinate.squaredDistance;
